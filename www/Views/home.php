            ...
            <div class="container">
                <?php if((isset($_SESSION["message"]) && ($_SESSION != NULL))){ ?>
                    <div class="d-flex justify-content-center">
                        <div class="mx-auto d-inline-flex align-items-center mb-5 col-md-10  alert alert-<?= $_SESSION["status"] ?> text-center" role="alert">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3">Les <?= count($GLOBALS["lesAnnonces"]) ?> dernières annonces</h1>
